...
const cacheName = 'A2TreyGleason-2021-02-28 16:11:31.232605'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2TreyGleason'.length) === 'A2TreyGleason') {
